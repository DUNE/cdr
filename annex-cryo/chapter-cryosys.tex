...
The Ross shaft contains the vertical piping connecting the 
...
The piping between the surface and cavern is located in a utility 
...
\begin{tabular}[htbp]{|p{0.28\textwidth}|p{0.31\textwidth}|p{0.18\textwidth}|p{0.15\textwidth}|}
\hline
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.42,angle=90]{cryosys-flow.png} 
...
Cryostat Prototype   &      &      &      &      &      \\
\hline
LBNF                 & 12452 & 129828 & \textcolor{red}{?}     &  5.5 & \textcolor{red}{?}\\
(Per Cryostat)       &      &      &      &      &      \\
\hline
\end{tabular} 
}
...
width=1.0\textwidth]{nitrogen-refrig-plant-flow.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{v5ch2refrigplant}
