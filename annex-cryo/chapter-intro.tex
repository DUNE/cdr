...
for acquiring and filling the cryostat, maintaining the 
LAr temperature within $\pm$1 K range around nominal 
temperature (88.3 K), and purifying the LAr outside the cryostat.
...
\item Transfer system to deliver gas argon and nitrogen to the underground detector cryostats
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth]{v5ch2-memb-tank-int}
