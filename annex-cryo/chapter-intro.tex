...
\label{ch:cryo-intro}
%\input{common/intro}  <--- no longer needed/appropriate 2015
...
cryogenics system that meets the performance requirements% together
for acquiring, maintaining \fixme{the LAr at 89~K?} and purifying the LAr in the detector. \fixme{It
gets purified outside the detector right?  Ambiguous}
...
\item Transfer system to deliver argon and nitrogen \fixme{in gas or liq form?} to the underground detector cryostats
...
The conceptual reference design for the DUNE far detector %LBNF 
