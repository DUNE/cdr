...
\begin{cdrfigure}[3D model of the signal feedthrough chimneys]{chimeneys_scheme}{3D model of the signal feedthrough chimneys}
...
\includegraphics[width=.5\linewidth]{fig-bittware.jpg}
\end{cdrfigure}
...
\begin{cdrfigure}[General organization of White Rabbit network]{WR-elements}{\small Left: general organization of a typical WR network. Right: standalone WR switch.}
