...
been developed provide high integration levels, significant cost
...
The front-end amplifiers are implemented as cryogenic CMOS ASICs
...
amplifiers must be housed in separate volumes (called chimneys) that
are completely distinct from the volume containing the pure LAr and
gas argon. They can therefore be replaced as needed without
contaminating the LAr inside the cryostat.
...
network for the trigger distribution. The light-readout digitization
