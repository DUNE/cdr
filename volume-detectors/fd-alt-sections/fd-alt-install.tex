...
preparations must be conducted and boundary conditions must be met \fixme{that's vague}  in
order to enable a safe and efficient process.
%allow one for both a safe as well a cost and time efficient
%realization of the detector installation. 
Some of the most important
preparation items are explained in more details in \anxlbnob. \fixme{I would expect that all
the details would be there.}

\subsection{Detector installation sequence}

This installation procedure has been extensively studied in the framework of the
...
of:
\fixme{Anne ran out of steam here; will start again tomorrow.}
\begin{enumerate}
...
\item{Install Charge Readout (CRP) from top scaffolding platform (detailed sequences described below figure \fixme{7)}}
\item{Thoroughly clean top level assembly}
