...
of the time corresponds more closely to %is linked with 
the instrumented surface required  rather than to %and not so much with 
...
\item{Construction \fixme{Assembly?}}
\end{enumerate}  
