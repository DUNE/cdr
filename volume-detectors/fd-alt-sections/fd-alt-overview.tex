...
\begin{cdrfigure}[Extraction efficiency vs electric field intensity]{extractionVsElectricField}{The left picture shows the dependence of the extraction time on the electric field in liquid argon (T~$= 87.4$~K) as reported in~\cite{Borghesani1990}.
...
\includegraphics[width=\linewidth]{extractionVsElectricField.pdf}
\end{cdrfigure}
...
\begin{cdrfigure}[Douple-phase detector 3D view]{DP_det1}{The DUNE dual-phase detector with cathode, field cage, anode with chimneys and PMTs. X and Y coordinates are indicated, with Y along the direction of the LBL neutrino beam.}
\includegraphics[width=\linewidth]{DP_det1.jpg}
\end{cdrfigure}

\begin{cdrfigure}[Douple-phase detector 3D view (partially open)]{DP_det2}{The DUNE dual-phase detector (partially open) with cathode, field cage, anode with chimneys and PMTs. X and Y coordinates are indicated, with Y along the direction of the LBL neutrino beam.}
...
%\begin{cdrtable}[Components and parameters for the 12kT (15kT) dual-phase LAr TPC]{clll}{DP_params}{Components and parameters for the 12kT (15kT) dual-phase  LAr TPC}  
