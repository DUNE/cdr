...
The alternate design is the result of 13 years of R\&D and two
...
The drift field is closed at the top by the anode. It consists of a
...
\begin{cdrfigure}[Dual-phase detector 3D view]{DP_det1}{The DUNE dual-phase detector with cathode,PMTs, field cage and the anode plane with chimneys.}
...
\begin{cdrfigure}[Dual-phase detector 3D view (partially open)]{DP_det2}{The DUNE dual-phase detector (partially open) with cathode,PMTs, field cage and the anode plane with chimneys.}
...
\begin{cdrfigure}[DUNE CRP 3~m$\times$3~m units.]{CRP_unit1}{Two DUNE CRP 3~m$\times$3~m units side by side. On the left one of the 79 equal CRP units, on the right the 1st CRP unit with a chamfered LEM/Anode Sandwich for the insertion of the high voltage feedthrough.}
...
\begin{cdrtable}[Sizes and Dimensions for the 12~kt (15~kt) dual-phase LArTPC]{lll}{DP_params}{Sizes and Dimensions for the 12~kt (15~kt) dual-phase  LArTPC}  Item & Value(s) &  \\ \toprowrule
