...
technical developments are described in \anxlbnob~\cite{cdr-annex-lbno-2}, which was submitted to the
...
provided by LBNF, described in \vollbnf~\cite{cdr-vol-3}.  Similar to the reference design, 
