...
\begin{cdrtable}[Dual-phase (alternative) far detector performance parameters]{llll}{FD_req}{Subset of performance parameters specific to the alternative far detector design.}  
