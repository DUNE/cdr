...
\begin{cdrtable}[Interstage distances and electric field settings of the double phase readout components.]{lcccc}{crp_dist}{Interstage distances and electric field settings of the double phase readout components.}  %The third argument (reads {cc}) can use c, l, r or p{some length} 
...
\begin{cdrtable}[Components of the 4$\times$4 m$^2$ CRP.]{lcccccc}{crp_para}{Components of the 4$\times$4 m$^2$ LBNO CRP.} 
Component & $50\times50$ cm$^2$ anode & $50\times50$ cm$^2$ LEM & Signal  & Suspension  &readout strip &number of \\
& panels & panels & feedthrough & feedthrough &length (m)& channels\\ \toprowrule
...
\begin{cdrfigure}[Pictures of the assembly of a $3\times1$m$^2$ CRP.]{CRP_assembl}{Pictures of the assembly of a $3\times1$m$^2$ CRP.}
