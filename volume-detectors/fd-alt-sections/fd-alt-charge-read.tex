...
\fixme{This should be called something like ``The Charge Readout Plane'' because it's for DUNE not LBNO!}
...
The DUNE CRP is a down-sized version of the LBNO one with  dimensions of $3\times3$~m$^2$ and 3 signal feedthrough chimneys and 1920 readout channels.
 ...
 \subsubsection{The 0.5$\times$0.5 m$^2$  LEM/Anode Sandwich (LAS)}
...
\begin{cdrfigure}[Pictures of the LEM and anode along with microscope views ]{LEM_anode}{Top: pictures of the LEM and anode along with microscope
 ...
 \includegraphics[width=.45\textwidth]{LEM_anode_zoom}  
 \end{cdrfigure}
...
\begin{cdrfigure}[Charge deposition as function of track angle ]{anode_res}{Charge deposition measured on view 0 ( $\Delta Q0/\Delta s0$) as a function  of the track angle $\phi$ (left) and projection of the  $\Delta Q0/\Delta s0$ distribution in three $\phi$ intervals (middle). The right plot  shows the distribution of the difference between the total charge  collected on both views normalized to their sum}
