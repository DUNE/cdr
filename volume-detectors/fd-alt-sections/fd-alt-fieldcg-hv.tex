%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\section{The Field Cage, High Voltage System and Cathode} 
...
system.  \fixme{State if this HV is for the cathode or the FC or both} 
...
stainless-steel tubing and long radius elbows to EN 10217-7 shop. \fixme{Does
the preceding make sense? Not to me!}  The
...
construction and minimize the installation time. %The breakdown of
Each field-shaping coil is broken down %made
 into sets of three main modules. \fixme{What are these modules? How is the coil
 broken down?}
...
The DUNE 12-kt detector field cage would require %include 
...
\fixme{double grid structure? Below it says `top and bottom grid structures'}
grid structure in 2~m$\times$2~m bays, \fixme{`bay' is not described; I can't picture it}
...
cathode structure.  All specialist nodes \fixme{what are the nodes?} preparation and welding of
...
%requirement translates in a lighter and cheaper structure.   <--- this is repeated information
