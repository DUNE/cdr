...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Muon Cherenkov Detectors} % (WBS 130.03.03.04)}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Stopped-Muon Detector} % (WBS 130.03.03.02)}
...
%\includegraphics[width=4in,angle=0]{AbsorberElevationView2}
%\end{cdrfigure}
