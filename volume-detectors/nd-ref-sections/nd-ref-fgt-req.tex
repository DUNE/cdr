...
in ~\ref{cdrsec:detectors-nd-ref-fgt}, \fixme{This link is broken, what is cdrsec:detectors-nd-ref-fgt supposed to refer to?} meets the requirements  to accomplish the oscillation studies described in Section 3.8.2 of \volphys %~\ref{sec:physics-lbnosc-beamnd-req} 
and the short baseline precision measurements described in Sections 6.1.2 and 6.1.3 of \volphys %~\ref{sec-nd-sbp} and  ~\ref{sec-nd-np}. 
...
\begin{itemize}
    ...
    (see Section 6.1.2 of \volphys).  % ~\ref{sec-nd-sbp}). 
