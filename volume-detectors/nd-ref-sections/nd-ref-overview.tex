...
The scope of the \fixme{} includes the design, procurement, fabrication, testing, delivery and installation of the components of the DUNE near detector reference design: 
...
\item 
\end{itemize}
This chapter describes the reference design for the near detector that meets the required performance for the DUNE experiment.
