...
number of 215,040 electronics channels. The total mass of the STT, including targets and radiators, is approximately 8~t.  
...
The most important nuclear target is the argon target that constitutes
the DUNE far detector.  This target will consist of planes of 0.5-inch
diameter, 3.5-m-long aluminum tubes, with wall thickness 0.065-inch,
filled with argon gas pressurized to 140~atm ($\rho = 0.233$), with
sufficient Ar mass to provide $\sim$10 times the unoscillated
statistics expected in a 40~t FD.  We are currently investigating the
possibility to use C-composite tubes instead of Al to contain the
pressurized Ar gas.
