...
%---Roberto! we MUST show the Particle-ID using dE/dx. The theme to ID the particles 
% runs through the CDR. I had it in the text -- it should be put soon after the schematic.
