...
The straw walls are made by wounding together a film of carbon loaded
...
(XX) planes of straws will be alternated and arranged in modules, with
...
straw layers. The staggered design of double layers, the average
number of straw planes crossed by tracks, and the double-end readout
...
summarizes the main parameters of the STT design.
