...
%Section~\ref{ch:physics-nd}, as well as the DAE/DST Detailed Project
...
$1.45 \times 10^{-2} X_0$ ($(0.2 \times 10^{-2} X_0$ without
...
dimensions of appproximately 350~cm$\times$175~cm$\times$4.0~cm.  Each
...
The sub-modules will be assembled before being shipped to %put together into modules 
Fermilab. Each module will have a carbon composite frame around 
...
Finally, the cylindrical tubes used for the pressurized Ar gas can
...
\includegraphics[width=0.9\textwidth,angle=0]{ECAL_detail}
\end{cdrfigure}
