...
The scope of the Near Detector System DAQ and computing includes the design, procurement, fabrication, testing, delivery and installation of all the systems and components that comprise it: \fixme{edit this as needed}

\begin{itemize}
\item (list them)
\end{itemize}

The design presented here meets the required performance for \fixme{whatever it is supposed to do} for the DUNE near detector. The most significant requirements include ...
...
\fixme{Please make sure the text below explicitly addresses the requirements you list above.}
