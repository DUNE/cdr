...
\begin{cdrfigure}[3D models of the designs for the DUNE far detector]{FarDet-overview-SPDP}{3D models of two 10-kt detectors using the single-phase reference design (left) and one detector using the dual-phase alternate design (right) for the DUNE far detector to be located at the 4850L. }
\centering
...
The deployment of the four 10-kt modules at SURF will take several years with a vision guided by 
...
\fixme{check dates for coherence with strategy}
