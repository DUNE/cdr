...
infrastructure and physics software, \fixme{Are all the prototyping efforts on-project?
We might want to take the following phrase out and add another sentence, e.g.,
``The software and computing efforts, as well as some of the prototyping activities are 
off-project.''} 
...
to their TPC designs. \fixme{I think this is what was meant here. Check}
%The reference and alternate designs adopt complementary designs to collect the scintillation light. 
...
and subsequent modules. %, allowing for implementation of evolving LArTPC technologies. 
...
flexible approach to the far detector design %is the ideal response to 
...
program while allowing for %improvements and 
...
\fixme{Start with something like ``A few hundred meters downstream of the neutrino source, DUNE will install a near neutrino detector (NND) and 
a Beamline Measurement System (BLM), collectively called the Near Detector Systems (NDS).''}

The NDS will allow DUNE
to reach the ultimate \fixme{`ultimate' or the required sensitivity for meeting physics reqs?}
