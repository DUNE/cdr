...
The three years R\&D and prototyping phase will start with the 3D design of a prototype module. 
...
\begin{cdrfigure}[Basic GEANT4 Simulations of 1cm Straws for the prototype plan] 
...
\begin{cdrfigure}[Wire Tension Measurement studies for 20 micron and 30 micron]           
...
\begin{cdrfigure}[Signal from a single straw using the BARC pre-amp and a source]  
...
\begin{cdrfigure}[Longitudinal view of the electromagnetic shower in the downstream ECAL by 2 GeV photons]  
...
\begin{cdrfigure}[Laboratory refurbishment plan for the ECAL R \& D and assembly work]  
{ECAL_LabIITG}{Laboratory refurbishment plan for the ECAL R \& D and assembly work.}  
\includegraphics[width=1.0\textwidth]{ECAL_LabIITG}
\end{cdrfigure}
...
Muons identification will done with the Resistive Plate Chamber detectors made up of Bakelite electrodes. 
