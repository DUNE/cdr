...
\begin{cdrfigure}[Design of the radiator target plane with pressurized Ar gas for STT]
...
wires is 70~g.
\begin{cdrfigure}[STT wire-tension measurement studies (20~$\mu$m and 30~$\mu$m)]
...
\begin{cdrfigure}[Pulse and voltage-amplitude for the test STT chamber]
...
\begin{cdrfigure}[Signal from single straw (STT) using the BARC preamp and source]
...
\includegraphics[width=0.8\textwidth]{ECAL_LabIITG}
%\includegraphics[width=0.6\textwidth]{ECAL_LabIITG} <---- too small to read
\end{cdrfigure}
...
suitable for use in the %DUNE 
LBNF beam. The higher-radiation environment of Alcove 1 is more representative %similar 
