...
module. % and its success will be a important milestone towards the DUNE far detector construction and operation.
...
%
In order to make precise measurements, the DUNE  %prototype  (According to Mark, it's DUNE)
detector will
...
\item validate accuracy of MC simulations for relevant particle energy and orientation %ranges as well as directions 
...
% to separate the insulation volume. \fixme{separate insulation layer from what?} 
...
%The vessel is completed with a top cap uses the same technology.
%
...
loop), %\fixme{Not clear what this means} 
...
%\fixme{capturing it can't maintain the purity, it can keep it from escaping so that can be reliquified...}  
