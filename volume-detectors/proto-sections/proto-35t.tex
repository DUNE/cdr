...
\end{cdrfigure}
<<<<<<< Updated upstream
\fixme{in fig 9.4 the APA is not labeled; I guess we all know it's the purple plane; if I'm wrong, it needs labeling! Purple frame with green wires...}
=======
%\fixme{in fig 9.4 the APA is not labeled}
>>>>>>> Stashed changes
