...
The 35-t (metric ton) LAr prototype was designed to demonstrate that a non-evacuable
membrane cryostat could satisfy the DUNE far detector requirement that oxygen contamination
of the LAr be less than 100 parts per trillion (ppt) and 
stably maintain that level.  In addition, construction and operation of the
...
decisions, e.g., developing plans for replacing pumps in a way that prevents
loss of purity.  
%\fixme{check edit} %when switching pumps is undesirable, and can likely be avoided by improved system design.
Future system designs could also avoid the coupling of acoustical
vibrations into the cryostat by locating the pumps externally; this
would have the added benefit of facilitating maintenance and repair.
