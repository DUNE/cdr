...
Once room-temperature gas phase stage is now longer improving purity, the cooldown and LAr fill stage begins. 
A gas/liquid spray method is used to cool down the cryostat. 
This generates a turbulent mixing of cold gas in the cryostat and cools the entire surface.
The cooldown rate was maintained below than the maximum specified by the manufacturer.
Once the cooldown was complete, the LAr was transferred into the cryostat and recirculating 
purification begun.
At this point, the purity monitors can be used to measure electron lifetime. 
...
achieving the stated goals of the LBNE Conceptual Design Far Detector. 
There were some operational issues, for example, the loss of purity when pumps are switched.
However, these are likely unique to the 35t. 
It also seems likely that in a future 
design, the pumps will be externally located, to avoid coupling 
acoustical vibrations into the Far Detector 
...
\subsection{35-ton Phase 2: Simulation, Reconstruction and Analysis}
