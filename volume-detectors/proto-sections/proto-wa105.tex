...
which corresponds to the readout cell size for the DUNE dual-phase detector module. %in the final far detector.  
...
and commissioning activities needed for the WA105 demonstrator. %6$\times$6$\times$6-m$^3$ detector.  
