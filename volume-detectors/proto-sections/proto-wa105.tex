...
\begin{cdrfigure}[Plan view section of the $6\times 6\times 6$ $m^3$]{6by6plan}{\small Plan view section of the $6\times 6\times 6$ $m^3$ }
\includegraphics[width=0.95\linewidth]{Detector_overview_horizcross}
\end{cdrfigure}

\begin{cdrfigure}[\small Vertical cross section of the $6\times 6\times 6$ $m^3$]{6by6vert}{\small Vertical cross section of the$6\times 6\times 6$ $m^3$}
