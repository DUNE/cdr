...
%
The drift path in the WA105 demonstrator reaches 6~m. The detector will operate 
with drift fields of 0.5~kV/cm and 1~kV/cm, corresponding to cathode voltages of
$-$300--600~kV. 600~kV  is the voltage also needed for the operation of the DUNE
far detector with  12~m drift at 0.5~kV/cm. The CRP has an active surface of 36 $m^2$, subdivided
...
which corresponds to the readout cell size in the final far detector.  
