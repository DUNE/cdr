...
6$\times$6$\times$6~m$^3$.
%\fixme{why not quote fiducial?} they call it 6x6x6, so I think this is OK.
...
which is readout cell size
%\fixme{which incorporates a readout unit of the minimum size possible for use in a DUNE far detector module?}  the minimal size of a readout unit 
in the final far detector.  
