...
20\% for electrons of energy below 50~MeV without corresponding
...
\subsection{Low-Energy Event Performance}

Low-energy (5--50~MeV) events require some special treatment.
Electron-type neutrino interactions
appearing close together in time is the signature for a supernova
burst event.  A \SI{5}{\MeV} electron is expected to hit four wires in the DUNE far
