...
the initial part of an electromagnetic shower is described in \anxreco~\cite{cdr-annex-reco}.  The first 2.5~cm of a shower is the most important, since 
...
described in~\cite{cdr-annex-reco} only uses the collection plane wires; 
