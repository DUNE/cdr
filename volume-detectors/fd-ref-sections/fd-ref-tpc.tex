...
Four planes of wires cover each side of an APA frame as shown in
...
At the nominal wire tension of 5~N, the total of \SI{3520} wires
...
A winding machine will be constructed to lay the \SI{3520} wires onto
...
the cryostat to minimize the surface electric field \fixme{magenta in
...
\end{cdrfigure}
\fixme{Would be nice to give dimensions in caption to figure~\ref{fig:tpc-UCLA-feedthrough}}
