...
Alternative photon detector designs
...
of the event t$_0$. 
\fixme{check edits to above pgraphs}
...
and 12 SiPMs, as shown in Figure~\ref{fig:PD_overview}~(a).  %To enable this, the
...
with a peak intensity around 430~nm, is re-emitted inside the bar and transported %. The light guide
