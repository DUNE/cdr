...
detector as they are currently defined. 
One of the primary science goals of DUNE is the detection of neutrinos from a
supernova burst, and while the TPC will be able to %provide SN neutrino detection
detect these neutrinos, the photon detector will be able to improve the momentum
