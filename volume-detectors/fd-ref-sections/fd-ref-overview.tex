...
%
%\fixme{Tom will amplify on expected performance for low and high energy events.}
%
%The expected performance of the DUNE far detector is based on the
%measured performance of the ICARUS detector, scanned Monte Carlo
%events and newer studies with automated reconstruction. The {\bf
%  PRELIMINARY} projected performance of the reference design far
%detector are summarized in Table~\ref{tab:TPC-metric}.
