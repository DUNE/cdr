...
will deploy four \ktadj{10} (fiducial) mass far detector LArTPCs. %(FD) Liquid Argon Time
%Projection Chambers (LArTPC).  (it's been spelled out enough by this point! Anne)
...
The LBNF Project will provide four cryostats at the 4850L of SURF in which the DUNE Collaboration
will deploy four \ktadj{10} (fiducial) mass far detector LArTPCs.
The first \ktadj{10} LArTPC will be based on
...
The reference design is already relatively advanced for  the %a
...
\item It is recognized that a detailed cost-benefit study of potential
  ...
  priority to the DUNE Project. \fixme{Project or Collaboration or both?}
\end{itemize}
...
an ultimate \fixme{`ultimate' again} long-baseline oscillation program, there may be benefits
...
detector. \fixme{for the NDS or the NND? Holy moly.}
