...
\subsubsection{Data Streams and the Scope of this Chapter}
...
out of the LAr TPC in real time. Multiple SNB neutrinos are expected to arrive and interact in the detector suring the possible rare Supernova burst event,
as opposed to a single vertex produced by a beam neutrino. To support SNB physics, data will need to be processed ``on the fly'' using approaches and
