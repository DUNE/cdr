...
Detailed GEANT4-based~\cite{Agostinelli:2002hh,Allison:2006ve} Monte Carlo simulations have been 
...
Hits must be associated between views in order to break the discrete ambiguity
