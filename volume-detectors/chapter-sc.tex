...
Supernova neutrino bursts on the other.  Signals produced by
...
produced by supernova neutrino bursts neutrino interactions is in the range of tens of MeV.
...
to be handled in the process of supernova neutrino bursts search can be expected to be quite significant. 

Another differentiating supernova neutrino bursts feature is that \textit{multiple neutrinos are
...
signature in the data stream and trigger recording of the potential supernova neutrino bursts event.

Characteristic
time scale for such supernova neutrino bursts data capture will be $\sim$\SI{10}{\second}.
