...
which only includes the beam neutrino type of events. This translates into 0.6PB/year.
...
\end{itemize}
\
Based on these parameter, we estimate that the upper limit of the ND data rate will be 1.5MB/s. This translates into 45TB/year. 
