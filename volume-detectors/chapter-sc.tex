...
%In the single-phase reconstruction, 
%the availability of three views provides strong constraints on 3D ambiguities.
...
For the single-phase technology, the PANDORA reconstruction chain
has been applied to accelerator neutrinos in the energy range 
100\,MeV\,$-$\,25\,GeV, using the MicroBooNE detector simulation.
...
reconstructing the primary interaction vertex in the 5\,GeV $\nu_{\mu}$ CC sample,
