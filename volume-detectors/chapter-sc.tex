...
In particular, the data from the ICARUS~\cite{REF1} and ArgoNEUT experiments~\cite{REF2}
...
The remaining hits are then disambiguated by clustering together the trivial hits.
