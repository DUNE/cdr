...
The wrapping of induction-plane wires in the single-phase detector design
...
and has been applied to 3D track reconstruction by both ICARUS~\cite{Ankowski:2006ts} and ArgoNEUT~\cite{REF2}.
...
a precise reconstruction of two-body final states~\cite{LAGUNA-LBNO-deliv}. 
...
The current performance has been evaluated using fully reconstruction 
