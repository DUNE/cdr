...
supported by multi-purpose and shared frameworks such as LArSoft and Qscan.
...
The identification of neutrino event types is based on a multivariate analysis\cite{WA105_TDR,LAGUNA-LBNO-deliv,LAGUNA-LBNO-EOI},
...
The current performance of the full reconstruction, from pattern recognition to event classification, 
...
For selected events, the neutrino energy is estimated kinematically for quasi-elastic events,
using a two-body approximation, or otherwise calorimetrically.
