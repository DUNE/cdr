...
\nomenclature{BLM}{(DUNE NDS) beamline measurement (system); also (LBNF beamline) beam loss monitor}
...
\nomenclature{\ktMWyr}{exposure, expressed in kilotonnes $\times$ megawatts $\times$ years} % kt.MW.yr
