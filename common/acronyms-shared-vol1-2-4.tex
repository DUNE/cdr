...
\nomenclature{\ktyr}{exposure (without beam), expressed in kilotonnes times years, based on $1\times 10^{21}$ protons-on-target per year at 120 GeV}
\nomenclature{\ktMWyr}{exposure, expressed in kilotonnes $\times$ megawatts $\times$ years, based on $1\times 10^{21}$ protons-on-target per year at 120 GeV} 
