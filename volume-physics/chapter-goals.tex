...
\end{itemize} 
The history of particle physics tells us that many of the breakthroughs
have been serendipitous, in the sense that they were beyond the
original scientific objectives of an experiment.  Nevertheless, the
room for such outcomes certainly depends on the capacities of the
new program to reach  beyond the scope of previous activities.
The beam power and novel capabilities for both the near  and far detector
provide just such a leap into new and unknown areas of parameter
space for both the accelerator-based and astrophysical frontiers
