...
\begin{itemize}
   \item {\bf What is the origin of the matter-antimatter asymmetry in the Universe?} Immediately after
                    ...
                    By studying the properties of neutrino and antineutrino oscillations to determine if charge-parity (CP) symmetry is violated in the lepton sector, \fixme{from Carl A: in particular, the predicted presence and extent of leptonic CP violation} \fixme{MB: I dont agree with Carl's statement, there is no definitive prediction of CP violation, but I added an extra qualification - I dont think CP has been defined before here so I spelled it out - may want to check that this meshes. } LBNF/DUNE 
                    will pursue the current most promising avenue for understanding this asymmetry.
   \item {\bf What are the fundamental underlying symmetries of the Universe?} The patterns of mixings and masses between the particles of the Standard Model are not understood. By making precise measurements of the mixing between the neutrinos and the ordering of neutrino masses and comparing these with the quark sector, LBNF/DUNE could reveal new underlying symmetries of the Universe.
...
original scientific objectives of their experiments. The intense LBNF neutrino beam and novel capabilities for both 
...
\begin{itemize}
      ...
      \item measurement of neutrinos from astrophysical sources at energies from %GRBs
      gamma-ray bursts, active galactic nuclei, black-hole and neutron-star mergers, or other transient sources.
\end{itemize}
