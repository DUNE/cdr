...
\input{volume-physics/table-nd-rates}
...
rich panoply of physics %composed of
...
% In the following we list the physics measurements required in the
% near detector in order to
...
A precise measurement of $\pi^0$ and photon yields by the near
...
$\tau-$ appearance in the far detector.  %We point that o
One of the
...
times as many in antineutrino mode. %while focusing antineutrinos.
...
Precision measurements of structure functions and differential cross
...
% The near detector may be able to make precision measurements of
% electroweak physics. \fixme{check}
...
To accomplish this, neutrino and anti-neutrino scattering off hydrogen
...
The most effective mechanism of sterile neutrino production is through
...
Since the signature of DM events looks just like those of the
