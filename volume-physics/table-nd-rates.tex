\begin{cdrtable}
[Interaction rates, $\nu$ mode, per ton
for \SI{1e20}{\POT}, \SI{459}{\meter}, \SI{120}{\GeV}]
{lrr}{rates}
{Estimated interaction rates on Ar (Carbon) in the neutrino (second column) and antineutrino (third column) beams per ton of detector 
  ...
  include detector efficiencies or acceptance~\cite{DOCDB740,DOCDB783}. \fixme{Must update table for 574m and reduce number of significant digits!!}
}
%\footnotesize{
