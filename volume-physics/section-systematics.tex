...
detector (ND) suggest this is an appropriate goal, predicting 2\% uncertainty on the absolute flux and
1-2\% uncertainty on the flux shape.
...
the parent mesons which will constrain the near/far flux ratio.
...
dedicated hadron production measurements such as those at NA61/SHINE are expected to reduce these
...
%section. 
  ...
  its relatively small contribution to the overall cross section. Data from \minerva[cite PRL], T2K, and
...
near detector.
%The validity of the GENIE model parameter uncertainties are being
...
%uncertainties. ETW Note: Dan, I think I keep taking this out and you keep putting it back in.
%I wrote this when the section was much shorter. My argument for removing it now is that
%these studies have been described in the paragraphs immediately
%preceding, so in the interest of keeping this concise I don't want to repeat it here.
%
