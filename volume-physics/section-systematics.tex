...
and T2K~\cite{Abe:2015awa} compared to the goal \fixme{goal or expected? If `goal', I'd use `target'; match with figure caption} uncertainties in a similar DUNE analysis.
...
DUNE 35-t prototype (Section~\ref{sec:proto=35t}), LArIAT~\cite{Adamson:2013/02/28tla},
