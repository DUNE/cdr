...
and the expected capability of the DUNE Near Detector (ND) as outlined in Chapter~\ref{ch:detectors-nd-ref}.
...
This category of uncertainties results from uncertainties in modeling neutrino interactions with the target
