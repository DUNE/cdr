...
less than 1\%~\cite{DanSaidSo}. This constraint increases
...
section models (QE, resonance production, and DIS) contribute roughly equally to the \nue/\anue
appearance signal samples. In most cases, these uncertainties come from the hadron tensor part of the
...
section. 
  ...
  \emph{Resonance production}: Resonance interactions account for roughly 1/3rd of the \nue appearance
