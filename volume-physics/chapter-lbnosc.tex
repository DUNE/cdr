...
inputs. In this document, a range of possible physics
sensitivities are presented that depends on the design of the neutrino beam, 
...
detector located 1,300 km away at the Sanford Underground Research
...
as upgrades to 2.4MW and improvements to uptime and efficiency, and
reductions in systematic uncertainties. The reference beam design is
described in detail in Volume 3. In this section a summary of the
...
thickness to accommodate the 1.2 MW primary proton beam, and focusing
...
momentum. We estimate that these quantities improve very slightly as
proton momentum decreases, until approximately 60 GeV, where the Main
...
otherwise noted, results throughout this volume assume an 80 GeV
...
phase and mass hierarchy.  One option, which we will call enhanced
...
configurations for this enhanced reference beam, one 204 m long and 6
m in diameter and the other 250 m long and 4 meters in diameter.  The
neutrino fluxes for these options, generated with an 80 GeV/c primary
proton beam, are shown in Figure~\ref{fig:beam_req_focusing_comp}.
...
provides some information on one of such
CP-phases~\cite{Klop:2014ima}, and the sensitivity has been studied
...
\item Shall be capable of operating with a single-turn fast extracted
  ...
  power. It must be able to accept proton momenta between 60 and 120
  GeV/c, since this will enable some optimization of the neutrino
...
\item Shall be built to provide a realistic estimation and whenever
  ...
  measurements from 60-120 GeV/c protons will be needed to reduce the
