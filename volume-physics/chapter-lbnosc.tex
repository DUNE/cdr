...
Research Facility. The neutrino facility must be designed for $\geq 20$ years operation to provide the DUNE experiment with a large enough statistics of neutrino interactions, before the experiment wil become limited by systematics. During its lifetime, the facility must be able to fit different target and focusing system configurations to provide some tunability in the energy range of the neutrinos, and must be suitable for upgraded targets and horns as the technology will improve and the primary proton beam power will increase. Such a flexibility is an essential requirement for a facility that will have to operate over a couple of decades. The energy range of the neutrino beam may need to adapt to possibly somewhat different questions in neutrino physics that may come up during such a long period.
The LBNF facility:
\begin{enumerate} 
