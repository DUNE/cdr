...
\begin{itemize}
 ...
 \item Year 7: Upgrade of beam power to 1.14~MW
\end{itemize}
Figure~\ref{fig:mh_staging} shows the MH sensitivity as a function of time considering this very preliminary staging plan.
...
{beam_req_sensitivities}{Sensitivity to the mass hierarchy (left) and
  ...
  the beam options discussed in Section~\ref{sec-alternative-focusing-systems.}}
