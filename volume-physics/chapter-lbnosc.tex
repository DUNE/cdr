...
Table~\ref{tab:oscpar_nufit}.  Most of the sensitivities in this chapter are shown assuming normal hierarchy; this is an arbitrary choice for simplicity of presentation.
...
The expected sensitivity can be reported as  
$\overline{\Delta\chi^2}$, representative of the mean value of $\Delta\chi^2$ that 
would be obtained in an ensemble of experiments for a particular true MH.  
It is assumed that the $\Delta \chi^2$ metric follows the expected chi-squared
