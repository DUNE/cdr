...
\item Identification of Electron Neutrino and Antineutrino Events: The
  ...
  antineutrino charged current beam events in sufficient numbers \fixme{sufficient to allow 
  identification of the  primary final-state charged electron (which leads to id of neutrino flavor as
  e type)? Can this be clarified? (Anne - who else?)}
  within the fiducial volume of the detector. The neutrino flavor of
  the event will be identified by clearly identifying the primary
  final state charged electron. The total energy of the charged
...
\item Muon Neutrino and Antineutrino Events: The FD shall be capable
  ...
  events in sufficient numbers \fixme{Again, sufficient numbers to allow id of primary muon? Does
  that lead to id of neutrino as  a muon type? (Anne)} within the fiducial volume of the
