...
test statistic values in terms of confidence intervals is different than in the standard case.
...
%\fixme{Need some clear discussion of what the uncertainties are without the ND and in the early stages of the ND ...MB}
...
decay-in-flight. It will aim the neutrino beam toward the DUNE far
...
phase and mass hierarchy.  One option, which will be referred to as the \emph{enhanced}
reference beam, 
...
%tunability in (that's not a real word)
tuning of the neutrino energy spectrum, and must be suitable for
...
\item The neutrino beam spectrum shall cover the energy
  ...
  conversion from the atmospheric parameters. For a baseline of \SI{1300}{\km}, 
  with the current knowledge of parameters, the first two nodes
...
\item The beam shall be sign-selected to provide separate neutrino and
  antineutrino beams with high purity to enable measurement of CP
...
\item The electron neutrino content in the beam shall be kept small so
  that the systematic errors on the additional background have a small
