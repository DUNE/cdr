...
\begin{cdrfigure}[Current and projected nucleon decay lifetime limits 
                  compared with ranges predicted by GUTs]
                 {PDK-limits-theory}
...
\begin{cdrtable}[Background Summary for Nucleon Decay]{lll}{tab:pdkbkds}
...
%
\begin{cdrtable}
[Atmospheric-neutrino event rates]{lc}{tab:atmos_rates}{Atmospheric-neutrino event rates including oscillations in \SI{350}{\ktyr} with a LArTPC, fully or partially contained in the detector fiducial volume. }
