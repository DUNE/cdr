...
$\theta_{23}$ (right).  For comparison, Hyper-K sensitivities are also shown \cite{}.}  
...
Atmospheric neutrino analyses have placed limits
on CPT violation, non-standard interactions, mass-varying neutrinos, sterile neutrinos \cite{Abe:2014gda}, and
Lorentz invarance violation.
