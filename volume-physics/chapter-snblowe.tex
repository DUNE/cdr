...
The initial spectra get further processed (permuted) by flavor oscillations and understanding these oscillations is very important to extracting physics from the detected signal.
...
\begin{figure}[!htb]
\centering
\includegraphics[width=2.4in]{garching_energy_plot.pdf}
\includegraphics[width=2.4in]{garching_time_plot.pdf}
\vspace{-5pt}
...
\fixme{Alex F. to update shortly}
...
\fixme{Update to refer to 40 kt, longer period}
