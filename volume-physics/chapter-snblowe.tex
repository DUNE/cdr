...
\begin{cdrtable}[Event rates for different models in \SI{40}{\kt} of LAr for
    a core-collapse at 10~kpc]{lcc}{tab:argon_events}{Event rates for different
...
\caption[DUNE SN sensitivities to oscillation-free coefficients for Lorentz and CPT violation]{DUNE supernova sensitivities to oscillation-free coefficients for Lorentz and CPT violation. Studies of DUNE supernova neutrinos can measure many coefficients (green) at levels improving over existing limits (grey). These Lorentz- and CPT- violating effects leave oscillations unchanged and so are unobservable in atmospheric or long-baseline measurements~\cite{kostelecky}.}
\label{fig:snliv}
\end{figure}
