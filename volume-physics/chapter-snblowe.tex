...
The analysis will make use of two types of information. First, the total energy of the emitted neutrinos should be compared with the expected release in the gravitational collapse. 
...
\ktadj{34} LArTPC, assuming a \MeVadj{4.5} neutrino energy
threshold and 31\% $\nu_e$ survival, is 122 per day in 40 kt.
%
% \begin{table}[!htb]
...
induction-plane charge and track-length-based reconstruction in this preliminary study; however improved reconstruction based on broader information could be possible in the future.}
