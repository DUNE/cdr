...
disambiguated sample.  Figure~\ref{disambig_annex} shows the
...
\includegraphics[width=0.6\textwidth]{disambigfractions_36.pdf}
\end{cdrfigure}
...
Figure~\ref{recoannexpandoraperformancemetrics} shows purity and completeness metrics ...
