...
coordinating bodies as shown in Figure~\ref{fig:dune-org}. %{fig:lbnfdune-org}.
...
\fixme{You haven't introduced the RRB-Computing group, if there is one}
...
infrastructure that support the science program. 
\fixme{Don't want to mention LBNF by name here?} 
In this capacity, Fermilab reports
directly to the DOE through the Fermilab Site Office (FSO).
Fermilab also has an important oversight role for the DUNE project \fixme{`DUNE project' not well defined here}
