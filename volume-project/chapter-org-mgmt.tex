...
\begin{itemize}
\item DUNE Collaboration, including the General Assembly (the Collaboration) and the DUNE Institutional Board \fixme{it ``G.A. of the Collaboration'' didn't sound like it included the collab members}
...
\fixme{What about non-CERN prototyping efforts? Where does 35-t fall?}
...
extend the membership as needed %deemed necessary 
