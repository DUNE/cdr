...
\item DUNE Project, containing the Project Office, headed by the Project Manager, and the managers of the DUNE detector and prototyping groups \fixme{does the Project also contain the worker bees that are designing and constructing things?}
