...
% Details of the agreements with CERN will be contained in [name the agreements here]. 
\fixme{I added ``is expected to'' language. 5/26 Anne}  
...
\begin{itemize}
\item DUNE Collaboration, including the General Assembly (the Collaboration) and the DUNE Institutional Board \fixme{slight edit because ``G.A. of the Collaboration'' didn't sound like it included the collab members}
...
\fixme{I would remove ``which acts as...'' The other three don't have this type of info}
\item DUNE Project, including the Project Office, headed by the Project Manager, and the managers of the DUNE detector and prototyping groups. \fixme{does the Project also contain the worker bees that are designing and constructing things? DUNE Project and DUNE Project Office (below) are not well distinguished}
...
\fixme{How does this relate to ``the DUNE Project''? Clarify}
