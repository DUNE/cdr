...
\fixme{The above is largely repeated from nd section and contains no information on strategy per se. I propose replacing
it with the contents of 3.5.3, e.g., }
...
\fixme{Move contents up and remove this section; Anne}
The contribution of Indian institutions to the design and construction of the DUNE 
