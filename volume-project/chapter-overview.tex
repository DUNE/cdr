...
complex, to become operational by \fixme{20yy} %2026
...
a minimum \ktadj{10} fiducial mass LArTPC %is 
...
operational by \fixme{20yy}, %2025
...
\fixme{MAT, follow SP suggestion --  could really do with a figure with a very high-level summary of the schedule. A picture is worth many words...}
...
in time to start excavation when the Ross Shaft rehabilitation work finishes %completes
 ...
 The far detector module \#1 is to be completed by fall \fixme{2024} with modules \#2 and \#3 completed
 one and two years later, respectively, and module \#4 completed by early \fixme{2027}.
