...
In the DUNE project, the 40-kt DUNE far detector (FD) is expected to
be built as four 10-kt modules, which will come online over the course
...
for the first 10~years of operation, the following staging plan has
been assumed:
\begin{itemize}
