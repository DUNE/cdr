...
\begin{cdrtable}[Exposures needed to reach physics
  milestones]{lcc}{execosctable}{The exposure in mass (kt) X (power
    (MW) X time (years) needed to reach certain oscillation physics
    milestones. The numbers are for normal hierarchy. The two columns
...
Physics milestone & Exposure kt-MW-years & Exposure kt-MW-years\\
  ...
  CPV at $5\sigma$ ($\delta_{cp} = +\pi/2$)  & 280 & 210 \\ \colhline
  MH at  $5\sigma$ (worst point) & 400 & 230 \\ \colhline
  $10^\circ$ resolution ($\delta_{cp} = 0$) & 450 & 290 \\ \colhline
  $1^\circ$ resolution ($\theta_{23} = 45^\circ$) &  &  \\ \colhline
  CPV at $5\sigma$ ($\delta_{cp} = -\pi/2$)  & 525 & 320 \\ \colhline
  CPV at $5\sigma$ 50\% of \deltacp & 810 & 550 \\ \colhline 
  CPV at $3\sigma$ 75\% of \deltacp & 1320 & 850\\ \colhline 
  Reactor resolution ($\sin^2 2 \theta_{13} = 0.084$) &  &  \\ \colhline
\end{cdrtable}
