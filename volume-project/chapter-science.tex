...
exposure of \SI{300}\ktMWyr{}. \fixme{SP question about all exposures defined in terms of equal nu and nubar running}
...
About a year after commissioning the first detector module, \fixme{check, right? (Change per SP)} the LBNF neutrino
...
\fixme{SP: figure uses 300 text uses 400}
...
scenario. \fixme{SP: question on figure doing what it says it does}
%
