...
six-year run with \SIadj{1.2}{\MW} beam power. 
...
%own. 
To reach $5\sigma$ for an appreciable fraction of the range of
...
% another idea \section{Nucleon Decay and Baryon Number Violation}
% pre-Anne \section{Searches for Baryon Number Violation}
...
%\section{Physics and Astrophysics with Supernova Neutrinos}
...
%\section{Physics with a Fine-grained Near Detector.}
