...
\fixme{sec 1.1 says 1.2 and 2.4 MW}
...
\fixme{Is it really a `range'; either it's one design or another and one exposure or another, no?}
...
\end{cdrfigure}
\fixme{fig should go in upper level figures dir and have no path here}
...
The DUNE near neutrino detector (ND) 
...
hierarchy determination and a measurement of the CP phase with some \fixme{some?}
