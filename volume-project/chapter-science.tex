...
% The \ktadj{40} DUNE far detector (FD) is expected to be built as four \ktadj{10} modules,
For reasons described later in Chapter~\ref{v1ch:strategy}, the DUNE far detector (FD)
will be built as four \ktadj{10} modules, which will come online over the course
...
MH sensitivity of DUNE with an exposure of \SI{300}\ktMWyr{}   
is illustrated in Figure~\ref{fig:mhexec} for the case of normal
...
With regard to the search for CP-violation
