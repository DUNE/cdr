...
\deltacp with high confidence \textit{within the same experiment}, i.e., DUNE. %\fixme{small wording change above per SP, then AH Jan 2016}
...
the LBNF neutrino
beam at Fermilab will %commence operation 
