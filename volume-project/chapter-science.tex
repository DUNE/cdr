...
mode) with a \ktadj{40} detector and a \SI{1.07}\MW{} beam (based on a \SI{80}\GeV{} primary proton beam).
...
For example, to reach $5\sigma$ sensitivity 
\fixme{Carl A asks: $3\sigma$? Table says 3 sigma at 75\%}
