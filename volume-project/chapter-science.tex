...
been assumed:
\begin{itemize}
\item Year 1: \SI{10}\kt{} FD mass; \SIadj{80}{\GeV} \SIadj{1.07}{MW} ($1.47 \times 10^{21}$ protons-on-target per year) beam; No ND
...
possible CP-violating asymmetry associated with the CP violating phase, \deltacp, of the 3-flavor PMNS mixing matrix, meaning that both the MH
and \deltacp can be determined unambiguously with high confidence
...
wide range of neutrino energies over the \SIadj{1300}{\km} baseline. In the
...
To reach $5\sigma$ sensitivity for 75\% of the range of \deltacp, a
