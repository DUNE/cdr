...
The primary science program of the LBNF/DUNE\fixme{it's the DUNE expt, not lbnf/dune} experiment focuses on fundamental open questions in neutrino and astroparticle physics: 
\begin{itemize}
...
The intense neutrino beam from LBNF, the massive DUNE LArTPC far detector and the highly-capable
\fixme{I hate this term, it doesn't mean anything; why not high-resolution?}
...
%been assumed:
\begin{itemize}
\item Year 1: \SI{10}\kt{} FD mass, \SIadj{1.07}{MW} \SIadj{80}{\GeV}
