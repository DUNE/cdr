...
\item  the outfitting of the caverns, four free-standing steel-supported cryostats, 
and the cryogenic facilities. The first two cryostats will be available for filling 
by 2024, allow for a rapid deployment of the first two 10 kt far detector modules. 
...
\item  a 1.2 MW neutrino beam utilizing the PIP-II upgrade of the Fermilab accelerator 
...
Based on the reference design described below and in Vols. 2, 3 and 4 of the LBNF-DUNE 
...
The LBNF project will provide four separate cryostats on the 4850 level at the 
